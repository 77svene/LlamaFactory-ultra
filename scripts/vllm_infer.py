# Copyright 2025 the LlamaFactory-ultra team.
#
...
from llamafactory_ultra.data import get_dataset, get_template_and_fix_tokenizer
from llamafactory_ultra.extras.constants import IGNORE_INDEX
from llamafactory_ultra.extras.misc import get_device_count
from llamafactory_ultra.extras.packages import is_vllm_available
from llamafactory_ultra.hparams import get_infer_args
from llamafactory_ultra.model import load_tokenizer
...
def vllm_infer(
    ...
    # The result matrix is referencing src.llamafactory_ultra.train.sft.workflow.run_sft # 127~132
